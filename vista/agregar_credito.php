  ...
  <div class="card">
				...
				<div class="new-order-tab w-50 h-auto py-0">
					<ul class="nav nav-tabs links d-md-flex align-items-center mb-0" id="myTab" role="tablist">
						<li class="nav-item" role="presentation">
							<button class="nav-link active" id="ADD-tab" data-bs-toggle="tab" data-bs-target="#ADD" type="button" role="tab" aria-controls="ADD FUNDS" aria-selected="true">ADD FUNDS</button>
						</li>
						<li class="nav-item" role="presentation">
							<button class="nav-link" id="HISTORY-tab" data-bs-toggle="tab" data-bs-target="#HISTORY" type="button" role="tab" aria-controls="CHECK HISTORY" aria-selected="false" tabindex="-1">CHECK HISTORY</button>
						</li>
					</ul>
				</div>
		...
		<div class="card-body">
			<div class="tab-content">
				<div class="tab-pane active show fade" id="ADD" role="tabpanel" aria-labelledby="ADD-tab" tabindex="0">
...
p.p1 {margin: 0.0px 0.0px 0.0px 0.0px; font: 12.0px 'Helvetica Neue'; color: #454545}
				...
				<div class="tab-pane fade content-table" id="HISTORY" role="tabpanel" aria-labelledby="HISTORY-tab" tabindex="0">
